        ...
        if (PlayerPrefs.GetInt("IsWave") == 1)
        {
            ...
            switch (PlayerPrefs.GetInt("Wave"))
            {
                ...
                case 6:
                    ...
                    {
                        GameObject enemy = Instantiate(tank, transform.position, Quaternion.identity);
                        tanks.Add(enemy);
                ...
                case 10:
                    ...
                    if (PlayerPrefs.GetFloat("Timer") > intervals && enemies > 0)
                    {
                        GameObject enemy = Instantiate(boss1, transform.position, Quaternion.identity);
                        enemy.transform.position = new Vector2(enemy.transform.position.x - 25, enemy.transform.position.y);
                        tanks.Add(enemy);
